...
type BankingServiceClient interface {
	...
	ExecuteTradeSettlement(ctx context.Context, in *structpb.Struct, opts ...grpc.CallOption) (*structpb.Struct, error)
}
...
func (c *bankingServiceClient) ExecuteTradeSettlement(ctx context.Context, in *structpb.Struct, opts ...grpc.CallOption) (*structpb.Struct, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type BankingServiceServer interface {
	...
	ExecuteTradeSettlement(context.Context, *structpb.Struct) (*structpb.Struct, error)
...
func (UnimplementedBankingServiceServer) ExecuteTradeSettlement(context.Context, *structpb.Struct) (*structpb.Struct, error) {
...
func _BankingService_ExecuteTradeSettlement_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BankingServiceServer).ExecuteTradeSettlement(ctx, req.(*structpb.Struct))
	}
	return interceptor(ctx, in, info, handler)
}
